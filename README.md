...
Для того чтобы всё работало, на вашем компьютере должны быть установлены две консольные утилиты (их нужно положить в ту же папку, что и батник, либо добавить в переменные среды Windows):
